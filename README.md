# sapper-template-rollup (TypeScript + ESLint + Prettier)
...
Thanks to https://github.com/regnaio/sapper-typescript I picked up some insights
over what to touch to enable TS in Sapper
...
- [x] Default VS Code configuration. Check the
      [VS Code configuration guide](VSCODE_CONFIGURATION.md)
...
```bash
# for Rollup
npx degit "NicoCevallos/sapper-template-rollup" my-app
# for webpack (maybe later)
# npx degit "NicoCevallos/sapper-template-webpack" my-app
```

### Using GitHub templates

Alternatively, you can use GitHub's template feature with the
[sapper-template-rollup](https://github.com/NicoCevallos/sapper-template-rollup)
~~or sapper-template-webpack repositoryies~~ repository.
